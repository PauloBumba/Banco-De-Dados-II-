...
-- 1. Consulta para exibir a classificação atual de uma modalidade e torneio
-- Esta consulta irá buscar a classificação das equipes em um determinado torneio e modalidade, ordenada pela pontuação:
...
-- 2. Consulta para listar os melhores jogadores por número de gols marcados
-- Essa consulta exibirá os jogadores que marcaram mais gols em suas partidas:
...
-- Você pode obter o resultado da primeira partida realizada em um torneio específico:
...
-- 4. Consulta para verificar a classificação de uma equipe em um torneio
-- Essa consulta retorna a posição de uma equipe específica em um torneio:
...
-- 5. Consulta para verificar o tipo de torneio e modalidades incluídas
-- Aqui você pode listar todos os torneios com suas modalidades associadas:
