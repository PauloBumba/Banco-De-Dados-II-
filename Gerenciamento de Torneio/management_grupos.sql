...
CREATE TABLE `grupos` (
  ...
  `quantidade_equipas` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `modalidade_id` (`modalidade_id`),
  CONSTRAINT `grupos_ibfk_1` FOREIGN KEY (`modalidade_id`) REFERENCES `modalidades` (`id`)
...
INSERT INTO `grupos` VALUES (1,1,'Grupo A','em_andamento',3);
