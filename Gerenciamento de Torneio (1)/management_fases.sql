...
CREATE TABLE `fases` (
  ...
  `quantidade_participantes` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `modalidade_id` (`modalidade_id`),
  CONSTRAINT `fases_ibfk_1` FOREIGN KEY (`modalidade_id`) REFERENCES `modalidades` (`id`)
...
INSERT INTO `fases` VALUES (1,'Fase de Grupos',1,'em_andamento',1,'2024-10-01','2024-11-01',16);
...
-- Dump completed on 2024-11-08 12:41:42
